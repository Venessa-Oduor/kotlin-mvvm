package com.venessa.mvvmandroid.ui.theme.screens.intent
...
fun Intentscreen(navController:NavHostController) {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val emailIntent =
                    Intent(Intent.ACTION_SENDTO,Uri.fromParts("mailto","oduorvenesa@gmail.com",null))
